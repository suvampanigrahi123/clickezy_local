    ...
    Terms: [
      {
        ...
        title: 'Introduction',
        description:
          'Welcome to Clickezy! These Terms of Service govern your use of our website located at www.clickezy.com. These Terms apply to all visitors, users and others who wish to access or use our Service.',
      },
      {
        id: 2,
      ...
      {
        id: 21,
        title: 'Limitation of Liability for Customer Claims',
        description:
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.',
      },
      {
      ...
      },
      {
        ...
        title: 'Contact Us',
        description:
          'Please send your feedback, comments, requests for technical support by email: info@clickezy.com.',
      },
    ],
    Policy: [
      {
            ...
            <Tab.Group>
              ...
              <Tab.Panels className="">
                {Object.values(categories).map((posts, idx) => (
                  <Tab.Panel
                    key={idx}
                    className="flex rounded-xl p-8 bg-slate-800/40 focus:outline-none"
                  >
                    <ul className="flex flex-col gap-6">
                      {posts.map((post) => (
                        <li
                          key={post.id}
                          className="flex flex-col gap-2 relative rounded-md"
                        >
